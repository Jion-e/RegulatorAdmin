  ...
  <div class="container">
    ...
    <div class="page-search">
      <el-form :inline="true" :model="searchForm">
        ...
        <el-form-item>
          <el-select clearable v-model="searchForm.type" placeholder="投诉类型">
            <el-option
    ...
    <div class="page-table">
      <el-table :data="complainList" fit border stripe @selection-change="handleTableSelection">
        ...
        <el-table-column prop="productDetail" label="产品型号"></el-table-column>
     ...
     <el-dialog class="dialog" title="查看" v-model="viewDialog" size="small" lock-scroll>
       <el-card class="dialog-card">
         <ul>
           ...
           <li>
             <span class="card-label">产品型号:</span>
       ...
       <el-card class="dialog-card">
         <el-form :model="complain" label-position="left" label-width="100px">
           ...
           <el-form-item label="隶属栏目">
             <el-select clearable v-model="complain.category" placeholder="隶属栏目">
               <el-option
                v-for="item in categories"
                :label="item.name"
                :value="item.id"
           ...
           <el-form-item label="性别">
             <el-radio v-model="complain.sex" :label=0>男</el-radio>
             <el-radio v-model="complain.sex" :label=1>女</el-radio>
           </el-form-item>
           <el-form-item label="联系电话">
             <el-input v-model="complain.phone"></el-input>
           </el-form-item>
           <el-form-item label="投诉类型">
             <el-select clearable v-model="complain.type" placeholder="投诉类型">
               <el-option
                v-for="item in complainType"
                :label="item.name"
                :value="item.id">
           ...
           <el-form-item label="生产厂家">
             <el-input v-model="complain.company"></el-input>
           </el-form-item>
           <el-form-item label="投诉内容">
             <el-input type="textarea" v-model="complain.request"></el-input>
           </el-form-item>
...
import { ComplainInit, PageInit, complainType } from '../api/config'
